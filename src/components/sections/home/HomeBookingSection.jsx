  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <motion.div
          variants={fadeUp}
          className="bg-white rounded-lg shadow-lg p-6 mb-20 max-w-5xl mx-auto"
        >
          <form
          ...
          >
            ...
            <button
              type="submit"
              className="bg-[#0f284f] text-white font-bold uppercase tracking-wider p-3 rounded hover:bg-[#1a3d72] transition-colors h-[46px]"
            >
              Search
            </button>
          </form>
          ...
          {loading ? (
            <>
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-100 animate-pulse flex flex-col h-[400px]"
                >
            ...
            <div className="col-span-full flex flex-col justify-center items-center py-12 md:py-20 bg-white rounded-lg border border-gray-100 shadow-sm w-full">
              <h3 className="text-[#0f284f] text-2xl font-bold uppercase tracking-wide mb-2">
                No Rooms Available
              </h3>
                  ...
                  <div className="p-4 md:p-6 flex-1 flex flex-col">
                    ...
                    <div className="flex justify-between items-end mt-auto flex-1 gap-2">
                      <p className="text-gray-500 text-xs md:text-sm leading-relaxed w-[60%]">
                        {room.description ||
                          "Experience comfort and luxury in our beautifully appointed rooms, designed to provide you with the perfect retreat during your stay."}
                      </p>
                      <div className="text-right w-[40%]">
                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">
                          FROM
                        </p>
                        <p className="text-xl md:text-3xl font-black text-[#0f284f]">
