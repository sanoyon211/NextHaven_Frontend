  ...
  return (
    <section className="py-20 bg-[#0f284f] w-full overflow-hidden relative">
      ...
      <div className="text-center mb-16 relative z-20">
        <h2 className="font-heading text-white text-3xl md:text-5xl font-bold mb-4">
          Guest Experiences
        </h2>
        <p className="text-gray-300 font-sans">
          What our esteemed guests say about NextHaven.
        </p>
      </div>
      ...
      <div className="flex w-max animate-marquee hover:[animation-play-state:paused]">
        {[1, 2, 3, 4, 1, 2, 3, 4].map((num, idx) => (
          <div
            key={idx}
            className="w-[85vw] sm:w-[400px] md:w-[450px] px-4 flex-shrink-0"
          >
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 flex flex-col h-full rounded-sm">
              ...
              <p className="font-sans text-gray-200 italic mb-6 flex-1">
                &quot;Absolutely breathtaking! The attention to detail, the
                luxurious rooms, and the impeccable service made our anniversary
                unforgettable.&quot;
              </p>
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-heading text-white font-bold text-sm">
                    Eleanor Williams
                  </h4>
                  <p className="font-sans text-[#d4af37] text-xs">
                    New York, USA
                  </p>
                </div>
              </div>
