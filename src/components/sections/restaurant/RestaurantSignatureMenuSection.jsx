...
export default function RestaurantSignatureMenuSection({ signatureMenu, loading, addToCart, handleOrderNow }) {
  return (
    <section id="signature-menu" className="mx-auto max-w-7xl px-4 py-12 md:py-24 sm:px-6 lg:px-8">
