...
export default function RestaurantHoursReservationsSection({
    ...
    <section className="bg-[#f8fafc] py-12 md:py-24 px-4 sm:px-6 lg:px-8 w-full">
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <motion.div
            variants={fadeUp}
            className="flex flex-col items-center text-center p-8 bg-white rounded-lg shadow-sm border border-gray-100"
          >
            <Clock className="w-10 h-10 text-[#ffbca8] mb-6" />
            <h3 className="text-[#0f284f] text-xl font-bold uppercase tracking-wider mb-6">
              Opening Hours
            </h3>
          ...
          >
            ...
            <p className="text-gray-500 leading-relaxed mb-6">
              We strongly recommend booking your table in advance, especially
              for dinner and weekend brunches. Walk-ins are accommodated subject
              to availability.
            </p>
            <button
          ...
          >
            ...
            <p className="text-gray-500 leading-relaxed mb-6">
              For private dining, large groups, or special dietary requirements,
              please speak with our restaurant manager.
            </p>
