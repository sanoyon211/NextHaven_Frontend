        ...
        <div className="flex flex-col gap-6 md:grid md:grid-cols-4 lg:gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-gray-300">
              <p>
                <a href="tel:+45356343444" className="hover:text-white transition-colors">
                  +45 35634 3444
                </a>
              </p>
              <p>
                <a href="mailto:contact@thehotel.com" className="hover:text-white transition-colors">
